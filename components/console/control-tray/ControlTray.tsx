...
function ControlTray({ children }: ControlTrayProps) {
  ...
  const handleExportLogs = () => {
    ...
    a.href = url;
    a.download = `journaux-api-live-${timestamp}.json`;
  ...
  const micButtonTitle = connected
    ...
    : 'Connecter et démarrer le microphone';

  const connectButtonTitle = connected ? 'Arrêter le streaming' : 'Démarrer le streaming';
    ...
    <section className="control-tray">
      <nav className={cn('actions-nav')}>
        ...
        <button
          ...
          title="Réinitialiser les journaux de session"
        >
      ...
      <div className={cn('connection-container', { connected })}>
        ...
        <span className="text-indicator">En direct</span>
      </div>
    </section>
  );
}
