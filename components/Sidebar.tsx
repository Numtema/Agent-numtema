    ...
    <>
      <aside className={c('sidebar', { open: isSidebarOpen })}>
        ...
        <div className="sidebar-content">
            ...
            <fieldset disabled={connected}>
              <label>
                ...
                <textarea
                  ...
                  rows={10}
                  placeholder="Décrivez le rôle et la personnalité de l'IA..."
                />
              </label>
              <label>
                Modèle
          ...
          <div className="sidebar-section">
            <h4 className="sidebar-section-title">Outils</h4>
                ...
                <div key={tool.name} className="tool-item">
                  ...
                  <div className="tool-actions">
                    ...
                    <button
                      ...
                      disabled={connected}
                      aria-label={`Supprimer ${tool.name}`}
                    >
            ...
            <button
              ...
              disabled={connected}
            >
              <span className="icon">add</span> Ajouter un appel de fonction
            </button>
          </div>
        </div>
      </aside>
